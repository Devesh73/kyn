  ...
  return (
    <section className="flex justify-between items-center py-16 px-8 bg-slate-950 shadow-lg h-screen min-w-[300px] max-w-[100vw] flex-wrap">
      <div className="text-white max-w-[50%] pr-8">
        <h1 className="text-4xl font-bold mb-4  text-purple-700">Welcome to the KYN Dashboard</h1>
        <p className="text-xl mb-6  text-purple-700">Empowering employees with AI-driven solutions</p>
        <NavLink
          to="/login"
